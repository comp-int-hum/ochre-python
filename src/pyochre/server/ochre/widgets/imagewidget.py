...
class ImageWidget(Textarea):
    template_name = "ochre/template_pack/image.html"
    id = None
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(ImageWidget, self).__init__(default_attrs)
    ...
    def get_context(self, name, value, attrs):
        ...
        context["style"] = {
            ...
            "endpoint_url" : self.endpoint, #reverse("api:machinelearningmodel-apply", args=(self.object.id,))
        }
        return context
